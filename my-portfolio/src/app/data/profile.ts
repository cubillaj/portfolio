...
export const experience = [
  {
    ...
    company: "SATEZO OPC",
    context: "June 2026 – Present",
    points: [
      "Build full-stack web applications from early requirements through implementation, deployment, and ongoing improvements.",
      "Translate client and user needs into practical interfaces, backend services, database structures, and third-party integrations.",
